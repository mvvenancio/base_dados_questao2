CREATE DATABASE base_dados_questao2;
USE base_dados_questao2;
...
FROM departamento d
LEFT JOIN divisao dv ON d.cod_dep = dv.cod_dep
...
WHERE v.tipo = 'V' -- Considerando apenas vencimentos do tipo 'V' (salários)
GROUP BY d.nome
